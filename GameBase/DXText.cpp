...
C_DX9_TEXT::C_DX9_TEXT( C_TINY_XML_ELEMENT * pElement )
{
	SetObject( pElement );
...
void C_DX9_TEXT::Calculate()
{
	GetString( TRUE );
}

void C_DX9_TEXT::MouseMove(  )
{
	C_DX9_WINDOW *pWindow = (C_DX9_WINDOW *)GetParent();
	dk::DPOINT Pos = *pWindow->GetAbsolutePos() + *GetRelPos();
...
void C_DX9_TEXT::UpdateObject( int iIndex )
{
